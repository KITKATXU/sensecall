...
stopwords = readLines('C:\\Users\\Administrator\\Desktop\\sensecall\\test\\stop-words.txt')
...
def extract_keywords(i):
    df = pd.read_csv('C:\\Users\\Administrator\\Desktop\\sensecall\\test\\IrMDgksAc.csv', index_col=0)
...
if __name__ == "__main__":
    ...
    print(result)
    # 热门带权值 
    file = open('comment/hot-weighted-value.txt', 'w+', encoding='utf-8')
    for i in range(100):
        #print(str(pairs))
    ...
    # 热门
    file = open('comment/hot.txt', 'w+', encoding='utf-8')
    for i in range(100):
