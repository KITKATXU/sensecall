...
import os
os.environ["BERT_BASE_DIR"] = "./chinese_L-12_H-768_A-12"
...
class BertConfig(object):
  ...
  def from_json_file(cls, json_file):
    ...
    with tf.io.gfile.GFile(json_file, "r") as reader:
      #text = reader.read()
      #text = tf.io.gfile.GFile("C:\\Users\\Administrator\\Desktop\\pinglun\\bert\\chinese_L-12_H-768_A-12\\bert_config.json", "r")

      f = open("C:\\Users\\Administrator\\Desktop\\pinglun\\bert\\chinese_L-12_H-768_A-12\\bert_config.json", "r")
      str = f.read()
...
class BertModel(object):
  ...
  label_embeddings = tf..compat.v1get_variable(...)
  ...
  for layer_idx in range(num_hidden_layers):
    with tf.compat.v1.variable_scope("layer_%d" % layer_idx):
      ...
      with tf.compat.v1.variable_scope("attention"):
        attention_heads = []
        with tf.compat.v1.compat.v1.variable_scope("self"):
